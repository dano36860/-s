                ...
                const modulesBySection = {
                        ...
                        ballcontrol: [{
                            ...
                            },
                            {
                                name: 'Jump Settings',
                                category: 'ballcontrol',
                                description: 'Configure jump settings (Right-click)',
                                type: 'switch',
                                action: 'Slope.hack.superJump.perform()',
                                iconUrl: null,
                                dropdown: true,
                                ...
                                dropdownOptions: [{
                                        ...
                                        action: 'Slope.hack.anticheat.selectSystem(VALUE)'
                                    },
                                    {
                                        label: 'Jump Force Value',
                                        input: true,
                                        inputType: 'number',
                                        placeholder: 'Enter jump force (1-100)',
                                        min: 1,
                                        max: 100,
                                        action: 'Slope.hack.superJump.setForceValue(VALUE)'
                                    },
                                    {
                                        label: 'Ball ESP Colour',
                                        colorpicker: true,
                                        defaultColor: '#4ecca3',
                                        action: 'Slope.hack.ballESP.setColor(VALUE)'
                                    },
                                    {
                                        label: 'Normal Mode',
                                        toggle: true,
                                        action: 'Slope.hack.jumpMode.setNormal()',
                                        actionOff: 'Slope.hack.jumpMode.setNormal()'
                                    },
                                    {
                                        label: 'Anticheat Bypass',
                                        toggle: true,
                                        action: 'Slope.hack.anticheat.bypass()',
                                        actionOff: 'Slope.hack.anticheat.disable()'
                                    },
                                    {
                                        label: 'Velocity Spoof',
                                        toggle: true,
                                        action: 'Slope.hack.velocity.spoof()',
                                        actionOff: 'Slope.hack.velocity.normal()'
                                    },
                                    {
                                        label: 'Packet Correction',
                                        toggle: true,
                                        action: 'Slope.hack.packet.correct()',
                                        actionOff: 'Slope.hack.packet.normal()'
                                    },
                                    {
                                        slider: true,
                                        label: 'Jump Force',
                                        ...
                                        value: 50,
                                        unit: '',
                                        action: 'Slope.hack.superJump.setForce(VALUE)'
                                    },
                                    {
                                        label: 'Auto Jump',
                                        toggle: true,
                                        action: 'Slope.hack.autoJump.enable()',
                                        actionOff: 'Slope.hack.autoJump.disable()'
                                    },
                                    {
                                        label: 'Bunny Hop',
                                        toggle: true,
                                        action: 'Slope.hack.bhop.enable()',
                                        actionOff: 'Slope.hack.bhop.disable()'
                                    },
                                    {
                                        label: 'Speed Boost',
                                        toggle: true,
                                        action: 'Slope.hack.speed.boost()',
                                        actionOff: 'Slope.hack.speed.normal()'
                                    },
                                    {
                                        slider: true,
                                        label: 'Jump Height',
                                        ...
                                        value: 10,
                                        unit: '',
                                        action: 'Slope.hack.superJump.setHeight(VALUE)'
                                    },
                                    {
                                        label: 'Air Control',
                                        toggle: true,
                                        action: 'Slope.hack.airControl.enable()',
                                        actionOff: 'Slope.hack.airControl.disable()'
                                    },
                                    {
                                        label: 'No Fall Damage',
                                        toggle: true,
                                        action: 'Slope.hack.noFall.enable()',
                                        actionOff: 'Slope.hack.noFall.disable()'
                                    }
                                ]
                            },
                            {
                        ...
                        utilities: [{
                            ...
                            },
                            {
                                name: 'Custom Command',
                                category: 'utilities',
                                description: 'Enter custom console command',
                                type: 'input',
                                placeholder: 'Type command...',
                                action: 'console.log("Executing: " + VALUE); eval(VALUE)',
                                iconUrl: null
                            }
                        ],
                        supportedsites: [{
                            ...
                            action: "window.open('https: {
                                ...
                                settings: [{
                                    ...
                                    {
                                        name: 'Pause on Menu Interaction',
                                        description: 'Automatically pause gameplay when the menu interface is opened or interacting with controls',
                                        type: 'toggle',
                                        action: 'window.hackMenuPauseEnabled = true; if(typeof game !== "undefined" && game.slop) game.slop.pause = true;',
                                        actionOff: 'window.hackMenuPauseEnabled = false; if(typeof game !== "undefined" && game.slop) game.slop.pause = false;'
                                    },
                                    {
                                        name: 'Show Arraylist',
                                        description: 'Display a glowing list of active modules in the top right corner with the Whisp branding',
                                        type: 'toggle',
                                        action: 'Swal.fire({title:"Feature in Development",text:"This feature is still in development.",icon:"warning",position:"center",showConfirmButton:true});',
                                        actionOff: 'Swal.fire({title:"Feature in Development",text:"This feature is still in development.",icon:"warning",position:"center",showConfirmButton:true});'
                                    },
                                    {
                                        name: 'Toggle Menu',
